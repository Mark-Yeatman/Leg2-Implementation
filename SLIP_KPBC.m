...
= SLIP_KPBC(IMU_pitch, Knee_joint_position, Ankle_joint_position, ...
            ...
            max_torque,...
            k_tilde, Ignore_PushOff, F_thresh,...
            Command_State,...
...
persistent hip_pos_prev...
    ...
    Espring = 1/2*k_tilde*deltaL^2; %virtual spring potential energy
    ...
    if SLIP_ON       
        ...
        U_LIN_DAMP_K = -u_lin_damp(4);% -u_G_shape(4);
        U_LIN_DAMP_A = u_lin_damp(5);% u_G_shape(5);
