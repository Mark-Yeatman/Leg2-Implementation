...
[Knee_torque_command, Ankle_torque_command, deltaL, hip_pos, t_out, dt, Esys]= SLIP_KPBC_v4(IMU_pitch, Knee_motor_position,Knee_joint_position, Ankle_motor_position, Ankle_joint_position, Iteration,...
