...
IMU_pitch=single(0);
Knee_motor_position=single(0);
Knee_joint_position=single(1); 
Ankle_motor_position=single(0);
...
[Knee_torque_command, Ankle_torque_command, deltaL, hip_pos, t_out, dt]= SLIP(IMU_pitch, Knee_motor_position,Knee_joint_position, Ankle_motor_position, Ankle_joint_position, Iteration,...
   ...
   q_h_0,q_h_min,c,s_po,FC,lf, la, ls, lt, k, d, L0, SLIP_ON);
