...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SLIP_KPBC.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SLIP_KPBC.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\codegen\lib\SLIP_KPBC;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=SLIP_KPBC -DHAVESTDIO -DUSE_RTMODEL
...
{$(START_DIR)\codegen\lib\SLIP_KPBC}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\SLIP_KPBC}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
