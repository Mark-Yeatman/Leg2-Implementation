 ...
 * File: _coder_SLIP_KPBC_v4_api.c
 *
...
/*
 * Arguments    : const mxArray * const prhs[37]
 *                const mxArray *plhs[6]
 * Return Type  : void
 */
void SLIP_KPBC_v4_api(const mxArray * const prhs[37], const mxArray *plhs[6])
{
  real32_T IMU_pitch;
  ...
  L0 = emlrt_marshallIn(&st, emlrtAliasP(prhs[36]), "L0");

  /* Invoke the target function */
  SLIP_KPBC_v4(IMU_pitch, Knee_motor_position, Knee_joint_position,
               Ankle_motor_position, Ankle_joint_position, Iteration,
               Iteration_time, Knee_torque_sensor, Ankle_torque_sensor,
               Load_cell_x_force, Load_cell_y_force, Load_cell_z_force,
               Load_cell_x_moment, Load_cell_y_moment, Load_cell_z_moment,
               kp_knee, kd_knee, kp_ankle, kd_ankle, ankle_ind_of_hip,
               knee_ind_of_hip, ankle_des_in, knee_des_in, time_in, filter_coeff,
               IMU_filter_coeff, q_h_0, q_h_min, c, s_po, FC, lf, la, ls, lt, k,
               L0, &Knee_torque_command, &Ankle_torque_command, &deltaL,
               &hip_pos, &t_out, &dt);
 ...
 * Return Type  : void
 */
void SLIP_KPBC_v4_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_SLIP_KPBC_v4_api.c
 *
 * [EOF]
 */
