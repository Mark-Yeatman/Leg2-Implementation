...
#include "main.h"
#include "SLIP_KPBC_v4_terminate.h"
#include "SLIP_KPBC_v4_initialize.h"

/* Function Declarations */
static float argInit_real32_T(void);
static void main_SLIP_KPBC_v4(void);
...
static void main_SLIP_KPBC_v4(void)
{
  ...
  /* Initialize function 'SLIP_KPBC_v4' input arguments. */
  ...
  /* Call the entry-point 'SLIP_KPBC_v4'. */
  SLIP_KPBC_v4(IMU_pitch, Knee_motor_position, Knee_joint_position,
               ...
               IMU_filter_coeff, q_h_0, argInit_real32_T(), argInit_real32_T(),
               argInit_real32_T(), argInit_real32_T(), argInit_real32_T(),
               argInit_real32_T(), argInit_real32_T(), argInit_real32_T(),
               argInit_real32_T(), argInit_real32_T(), &Knee_torque_command,
               &Ankle_torque_command, &deltaL, &hip_pos, &t_out, &dt);
}
